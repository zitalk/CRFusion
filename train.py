...
parser.add_argument('--load_pre', type=str, default='./pretrained/swin_base_patch4_window12_384_22k.pth', help='train from checkpoints')
parser.add_argument('--gpu_id', type=str, default='0', help='train use gpu')
parser.add_argument('--rgb_root', type=str, default='/home/b311/data2/Datasets/DUTLF-V2/Train/train_array_No_augmentation/', help='the training rgb images root')  # train_dut
parser.add_argument('--depth_root', type=str, default='/home/b311/data2/Datasets/DUTLF-V2/Train/train_ESI/', help='the training depth images root')
parser.add_argument('--gt_root', type=str, default='/home/b311/data2/Datasets/DUTLF-V2/Train/train_masks/', help='the training gt images root')
parser.add_argument('--test_rgb_root', type=str, default='/home/b311/data2/Datasets/DUTLF-V2/Test/test_images/', help='the test gt images root')
parser.add_argument('--test_depth_root', type=str, default='/home/b311/data2/Datasets/DUTLF-V2/Test/test_ESI/', help='the test gt images root')
parser.add_argument('--test_gt_root', type=str, default='/home/b311/data2/Datasets/DUTLF-V2/Test/test_masks/', help='the test gt images root')
# parser.add_argument('--save_path', type=str, default='./cptsmamba/', help='the path to save models and logs')
...
save_path = "./Results/CRFusion_DUTLF/"


os.makedirs(save_path, exist_ok=True)

logging.basicConfig(filename=save_path + 'CRFusionAblation.log',
                    format='[%(asctime)s-%(filename)s-%(levelname)s:%(message)s]', level=logging.INFO, filemode='a',
                    datefmt='%Y-%m-%d %I:%M:%S %p')
logging.info("CRFusion-Train")
print("CRFusion-Train")
model = CRFusion()
